...
public class SSDPSearchSocket extends HTTPMUSocket implements Runnable
{
	...
	public boolean isUseIPv6Address()
	{
	 ...
	 * @since 1.8
	 */
	public SSDPSearchSocket(String bindAddr, int multicastPort, String multicastAddr)
	{
		openForReceive(bindAddr, multicastPort, multicastAddr);
	}
	...
	public boolean openForReceive(String bindAddr, int multicastPort, String multicastAddr)
	{
		if ((HostInterface.isIPv6Address(bindAddr)) && (HostInterface.isIPv6Address(multicastAddr)))
		{
			useIPv6Address = true;
		} else if (HostInterface.isIPv4Address(bindAddr) && (HostInterface.isIPv4Address(multicastAddr)))
		{
			useIPv6Address = false;
		} else
		{
		...
		return openReceive(multicastAddr, multicastPort, bindAddr);
	}
	...
	public boolean open(String bindAddr)
	{
		...
		return open(ssdpAddr, SSDP.PORT, bindAddr);
	}
	...
	public void start()
	{
		StringBuffer name = new StringBuffer("iqiyi.SSDPSearchSocket/");
