...
public class SSDPSearchSocketList extends Vector<SSDPSearchSocket>
{
	...
	private int multicastPort = SSDP.PORT;
		...
		for (int i = 0; i < bindAddresses.length; i++)
		{
			...
			if (bindAddresses[i] != null)
			{
				...
				if (HostInterface.isIPv6Address(bindAddresses[i]))
					ssdpSearchSocket = new SSDPSearchSocket(bindAddresses[i], multicastPort, multicastIPv6);
				else
					ssdpSearchSocket = new SSDPSearchSocket(bindAddresses[i], multicastPort, multicastIPv4);
