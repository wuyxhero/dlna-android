...
public class ContentDirectory extends ThreadCore implements ActionListener, QueryListener
{
	...
	*/
	...
	{
		final String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/http";
		FileDirectory root = new FileDirectory("rootFile", path);
	...
	private int getSearchContentList(ContainerNode node, SearchCriteriaList searchCriList, SearchCapList searchCapList,
	...
	public int contentServiceRequestReceived(String resId)
	{
		...
		ContentNode node = findContentNodeByID(resId);
	...
	public void contentServiceRequestFinished(int connectionId)
	{
		MediaServer mserver = getMediaServer();
		ConnectionManager conMan = mserver.getConnectionManager();
		conMan.removeConnectionInfo(connectionId);
	}
	...
	{
		return "http://" + getInterfaceAddress() + ":" + getWebServerPort() + path + "?" + CONTENT_ID + "=" + id;
	}

	public String getContentExportURL(String id)
	{
		//		return "http://" + getInterfaceAddress() + ":" + getHTTPPort() + CONTENT_EXPORT_URI + "?" + CONTENT_ID + "=" + id;
		return "http://" + getInterfaceAddress() + ":" + getWebServerPort() + "?" + CONTENT_ID + "=" + id;
	}
	...
	public void run()
	{
		...
		if (mDirectoryUpdateListener != null)
		{
			mDirectoryUpdateListener.onDirectoryUpdate();
		}
	...
	{
		return mDirectoryUpdateListener;
	}
	...
	static public interface ContentDirectoryUpdateListener
	{
