...
public class SimpleWebServer extends NanoHTTPD
{
	...
	public Response serveFile(String uri, Map<String, String> header, File homeDir)
	{
		...
		if (res == null && f.isDirectory())
		{
			...
			{
				uri += "/";
				res = new Response(Response.Status.REDIRECT, NanoHTTPD.MIME_HTML, "<html><body>Redirected: <a href=\"" + uri
						+ "\">" + uri + "</a></body></html>");
			...
			Map<String, String> files)
	{
		...
		// String id = parms.get(ContentDirectory.CONTENT_ID);
		// FileItemNode node = (FileItemNode) mCDS.findContentNodeByID(id);
		// String fname = node.getFile().getName();

		Response resp = serveFile(uri, header, getRootDir());
		return resp;
	}
