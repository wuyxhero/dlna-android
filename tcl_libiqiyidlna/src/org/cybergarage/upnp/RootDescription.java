...
public interface RootDescription
{
	...
	public final String ROOT_ELEMENT_DLNANAMESPACE = "urn:schemas-dlna-org:device-1-0";

	public final String ROOT_ELEMENT_NS = "";
	public final String ROOT_ELEMENT_NSDLNA = "dlna";
