...
public class UPnP
{
	...
	public final static String NAME = "IQIYIDLNA";//两者都兼容起来
	public final static String VERSION = "1.0";

	public final static int SERVER_RETRY_COUNT = 100;
	public final static int DEFAULT_EXPIRED_DEVICE_EXTRA_TIME = 30;//心跳时长是30S
	...
	public final static int INMPR03_DISCOVERY_OVER_WIRELESS_COUNT = 5; //no use now
	...
	public static final String createUUID()
	{
		...
		return toUUID((int) (time1 & 0xFFFF)) + "-" + toUUID((int) ((time1 >> 32) | 0xA000) & 0xFFFF) + "-"
				+ toUUID((int) (time2 & 0xFFFF)) + "-" + toUUID((int) ((time2 >> 32) | 0xE000) & 0xFFFF);
	}
	...
	/**
	 * This method loads the default XML Parser using the following behavior: - First if present loads the parsers specified by
	 * the system property {@link UPnP#XML_CLASS_PROPERTTY}<br>
	...
	private static Parser loadDefaultXMLParser()
	{
		...
		{ System.getProperty(XML_CLASS_PROPERTTY), "org.cybergarage.xml.parser.XmlPullParser",
